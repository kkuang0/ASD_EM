...
def get_em_transforms(image_size: int = 224, 
                     is_training: bool = True) -> transforms.Compose:
    """
    ...
    training_transforms = [
        ...
        transforms.Resize(int(image_size * 1.05), interpolation=transforms.InterpolationMode.BILINEAR),
